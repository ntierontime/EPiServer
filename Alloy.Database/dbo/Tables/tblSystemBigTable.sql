CREATE TABLE [dbo].[tblSystemBigTable] (
    ...
    [Row]                INT              CONSTRAINT [tblSystemBigTable_Row] DEFAULT ((1)) NOT NULL,
    ...
    CONSTRAINT [CH_tblSystemBigTable] CHECK ([Row]>=(1)),
    CONSTRAINT [FK_tblSystemBigTable_tblBigTableIdentity] FOREIGN KEY ([pkId]) REFERENCES [dbo].[tblBigTableIdentity] ([pkId])
);
