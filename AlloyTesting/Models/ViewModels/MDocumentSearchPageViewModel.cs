...
{
    public class MDocumentSearchPageViewModel : PageViewModel<MDocumentSearchPage>
    {
        public MDocumentSearchPageViewModel(MDocumentSearchPage currentPage, string searchQuery)
            : base(currentPage)
        {
        ...
        public IContentResult<MDocumentFileBase> Results { get; set; }
        //public MDocumentSearchPageViewModel(MDocumentSearchPage currentPage)
        //    : base(currentPage)
        //{
        //}
