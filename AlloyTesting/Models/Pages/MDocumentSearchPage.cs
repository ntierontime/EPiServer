...
{
    [ContentType(DisplayName = "MDocumentSearchPage", GUID = "6884b19a-77f2-4637-a76e-aa6d247e08ab", Description = "MDocument Search Page", GroupName = Alloy.Global.GroupNames.Restricted)]
    [SiteImageUrl]
    public class MDocumentSearchPage : SitePageData, IHasRelatedContent, ISearchPage
    {
